...
namespace WebApi.Controllers
{
    ...
    public class PersonaController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IActionResult> Listar([FromQuery] int pageNumber = 1, [FromQuery] int pageSize = 10, [FromQuery] string sortField = "")
        {
            // Crear la consulta
            var query = new ListarUsuariosQuery(pageNumber, pageSize, sortField);
